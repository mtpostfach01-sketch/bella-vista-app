...
| BV-101 | SMS-Erinnerung am Vortag einer Reservierung | BR #22 · simuliert (kein SMS-Gateway angebunden, `/erinnerungen`) | ✓ |
| BV-102 | Warteliste für freie Tische | BR #26 · Marco unentschlossen · Benachrichtigung offen | ✓ |
| BV-103 | Schichtplanung + automatischer Trinkgeld-Vorschlag (Chef bestätigt) | BR #20 · Verteilschlüssel: proportional zum Umsatz (ADR-008) · `/schichtplanung`, `/trinkgeld` | ✓ |
| BV-104 | Catering-Modul (Firmenkunden, Events, Lieferadresse) | W6, W9 · Entitäten: Catering-Auftrag, Firmenkunde · `/catering` | ✓ |
| BV-105 | Gruppenmenü-Automatik ab 8 Personen + optionale Anzahlung | BR #6, #23 · `/speisekarte/gruppenmenues` + Reservierungsformular | ✓ |
...
| BV-108 | TSE-Kassenanbindung | ADR-004, ADR-007 · Stub (Statusmarker, keine echte Hardware-Kopplung) | ✓ |
| BV-109 | Gerichtsfotos in der Speisekarte | Nice-to-have · Foto-URL-Feld (kein Datei-Upload) | ✓ |
